...
use super::honk_verifier_circuits::{run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_17_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, is_on_curve_bn254};
...
mod UltraStarknetHonkVerifier {
    ...
    use super::{vk, VK_HASH, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_17_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, is_on_curve_bn254};
    ...
    impl IUltraStarknetHonkVerifier of super::IUltraStarknetHonkVerifier<ContractState> {
        fn verify_ultra_starknet_honk_proof(
            ...
            let (transcript, transcript_state, base_rlc) = HonkTranscriptTrait::from_proof::<StarknetHasherState>(vk.circuit_size, vk.public_inputs_size, vk.public_inputs_offset, full_proof.proof);
